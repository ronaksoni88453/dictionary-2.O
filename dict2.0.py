...
def A():
    ...
    Label(root, text="A-A-A-A", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="A-A-A-A", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="A-A-A-A", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="A-A-A-A", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def B():
    ...
    Label(root, text="B-B-B-B", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="B-B-B-B", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="B-B-B-B", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def C():
...
def D():
    ...
    Label(root, text="D-D-D-D", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=160)
    Label(root, text="D-D-D-D", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="D-D-D-D", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="D-D-D-D", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="D-D-D-D", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def E():
    Label(root, text="EXTERNAL LINK", width=20, font="comicansans 12 bold", height=2, bg="pink",).place(x=800,y=80)
    Label(root, text="E-E-E-E", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=120)
    Label(root, text="E-E-E-E", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=160)
    Label(root, text="E-E-E-E", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="E-E-E-E", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="E-E-E-E", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="E-E-E-E", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def F():
    ...
    Label(root, text="F-F-F-F", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=160)
    Label(root, text="F-F-F-F", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="F-F-F-F", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="F-F-F-F", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="F-F-F-F", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def G():
    ...
    Label(root, text="G-G-G-G", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="G-G-G-G", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def H():
    ...
    Label(root, text="H-H-H-H", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="H-H-H-H", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def I():
    ...
    Label(root, text="I-I-I-I", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="I-I-I-I", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="I-I-I-I", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def J():
    Label(root, text="JAVASCRIPT", width=20, font="comicansans 12 bold", height=2, bg="pink",).place(x=800,y=80)
    Label(root, text="J-J-J-J", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=120)
    Label(root, text="J-J-J-J", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=160)
    Label(root, text="J-J-J-J", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="J-J-J-J", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="J-J-J-J", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="J-J-J-J", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def K():
    ...
    Label(root, text="K-K-K-K", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="K-K-K-K", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="K-K-K-K", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def L():
    ...
    Label(root, text="L-L-L-L", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def M():
    ...
    Label(root, text="M-M-M-M", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="M-M-M-M", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="M-M-M-M", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="M-M-M-M", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def N():
    ...
    Label(root, text="N-N-N-N", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="N-N-N-N", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="N-N-N-N", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def O():
    ...
    Label(root, text="O-O-O-O", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="O-O-O-O", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="O-O-O-O", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def P():
    ...
    Label(root, text="P-P-P-P", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="P-P-P-P", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="P-P-P-P", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def Q():
    Label(root, text="QUERY", width=20, font="comicansans 12 bold", height=2, bg="pink",).place(x=800,y=80)
    Label(root, text="Q-Q-Q-Q", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=120)
    Label(root, text="Q-Q-Q-Q", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=160)
    Label(root, text="Q-Q-Q-Q", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="Q-Q-Q-Q", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="Q-Q-Q-Q", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="Q-Q-Q-Q", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def R():
    ...
    Label(root, text="R-R-R-R", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="R-R-R-R", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="R-R-R-R", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="R-R-R-R", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def S():
    ...
    Label(root, text="S-S-S-S", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="S-S-S-S", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def T():
    ...
    Label(root, text="T-T-T-T", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="T-T-T-T", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="T-T-T-T", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="T-T-T-T", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def U():
    ...
    Label(root, text="U-U-U-U", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="U-U-U-U", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="U-U-U-U", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def V():
    ...
    Label(root, text="V-V-V-V", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=160)
    Label(root, text="V-V-V-V", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="V-V-V-V", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="V-V-V-V", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="V-V-V-V", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def W():
    ...
    Label(root, text="W-W-W-W", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="W-W-W-W", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="W-W-W-W", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def X():
    Label(root, text="X-X-X-X", width=20, font="comicansans 12 bold", height=2, bg="pink",).place(x=800,y=80)
    Label(root, text="X-X-X-X", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=120)
    Label(root, text="X-X-X-X", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=160)
    Label(root, text="X-X-X-X", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="X-X-X-X", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="X-X-X-X", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="X-X-X-X", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def Y():
    Label(root, text="Y-Y-Y-Y", width=20, font="comicansans 12 bold", height=2, bg="pink",).place(x=800,y=80)
    Label(root, text="Y-Y-Y-Y", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=120)
    Label(root, text="Y-Y-Y-Y", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=160)
    Label(root, text="Y-Y-Y-Y", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="Y-Y-Y-Y", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="Y-Y-Y-Y", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="Y-Y-Y-Y", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def Z():
    Label(root, text="Z-Z-Z-Z", width=20, font="comicansans 12 bold", height=2, bg="pink", ).place(x=800, y=80)
    Label(root, text="Z-Z-Z-Z", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=120)
    Label(root, text="Z-Z-Z-Z", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=160)
    Label(root, text="Z-Z-Z-Z", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="Z-Z-Z-Z", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="Z-Z-Z-Z", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="Z-Z-Z-Z", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def clk():
    entered = ent.get()
